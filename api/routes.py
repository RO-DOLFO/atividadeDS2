...
from api.forms import FormEstoque, FormFuncionario, FormCliente, FormHistoricoCompra, FormProduto, FormRegistroInteracao, FormTarefa
from api.models import Cliente, Estoque, Funcionario, HistoricoCompra, Produto, RegistroInteracao, Tarefa
